...
T.Interior={
	...
	Tips={
		...
		{pos = Vector(42, 0.75, 27.1),       part = "default_screen"},
		{pos = Vector(46.2, 10.25, 38.6),    part = "default_screenbutton"},
		{pos = Vector(44, -18, 5.5),         part = "default_powerlever"},
		{pos = Vector(49, -27.75, 5.5),      part = "default_physbrake"},
		{pos = Vector(29, -53, -8),          part = "default_keyboard"},
		{pos = Vector(4.48, -43.9, 7),       part = "default_blacksticks"},
		{pos = Vector(-8.87, -50, 5.5),      part = "default_throttle"},
		...
		{pos = Vector(-6.62, 44.35, 7),      part = "default_repairlever"},
