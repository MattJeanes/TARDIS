...
T.Interior={
	...
	Tips={
		{pos = Vector(39, 22.75, 5.82),      part = "default_hads",               control = "hads",},
		{pos = Vector(19, 48.80, 2.07),      part = "default_typewriter",         control = "coords",},
		{pos = Vector(42, 0.75, 27.1),       part = "default_screen",             control = "monitor",},
		{pos = Vector(46.2, 10.25, 38.6),    part = "default_screenbutton",       control = "screen_toggle",},
		{pos = Vector(44, -18, 5.5),         part = "default_powerlever",         control = "power",},
		{pos = Vector(49, -27.75, 5.5),      part = "default_physbrake",          control = "physlock",},
		{pos = Vector(29, -53, -8),          part = "default_keyboard",           control = "destination",},
		{pos = Vector(4.48, -43.9, 7),       part = "default_blacksticks",        control = "cloak",},
		{pos = Vector(-8.87, -50, 5.5),      part = "default_throttle",           control = "throttle",},
		{pos = Vector(-9.94, -65, -12),      part = "default_biglever",           control = "fast_return",},
		{pos = Vector(-37.24, -27.91, 7.42), part = "default_longflighttoggle",   control = "long_flight",},
		{pos = Vector(-52, -29.5, 3.5),      part = "default_handbrake",          control = "handbrake",},
		{pos = Vector(-6.62, 44.35, 7),      part = "default_repairlever",        control = "repair",},
		{pos = Vector(-0.43, 55.75, 4),      part = "default_flightlever",        control = "flight",},
		{pos = Vector(-1.5, -60, 2),         part = "default_float",              control = "float",},
		{pos = Vector(-47.5, 26, 4),         part = "default_isomorphic",         control = "isomorphic",},
