...
T.Phrases = {
    ...
    ["Security.ControlUseDenied"] = "Эта ТАРДИС использует Изоморфную Защиту, вам нельзя использовать её управление",
    ...
    ["Settings.Sections.Exterior.Light.AlwaysOn"] = "Лампа экстерьера всегда включена",
    ["Settings.Sections.Exterior.Light.AlwaysOn.Description"] = "Стоит ли лампе экстерьера светиться всегда?",
    ["Settings.Sections.Exterior.Light.ColorOverride"] = "Пользовательский свет",
    ["Settings.Sections.Exterior.Light.ColorOverride.Description"] = "Использование пользовательского цвета лампы экстерьера",
    ...
    ["Settings.Sections.Exterior.ProjectedLight.ColorOverride.Description"] = "Пользовательская яркость проецируемого света",
