...
T.Phrases = {
    ...
    ["Settings.Sections.Performance.ProjectedLights"] = "Interior Projected Lights",
    ["Settings.Sections.Performance.ProjectedLights.Description"] = "Enable additional interior projected lights",
    ["Settings.Sections.Performance.NoExtraLights"] = "Disable Interior Extra Lights",
    ["Settings.Sections.Performance.NoExtraLights.Description"] = "Have only one light source per interior",
