...
T.Phrases = {
    ...
    ["Chameleon.ExteriorPlanned"] = "A change of exterior has been planned. It will be applied when the TARDIS lands next time",
    ...
    ["Exteriors.TTCapsuleType55B"] = "TT Capsule Type 55-B",
    ...
    ["Interiors.Default.Versions.TTCapsuleType55B"] = "TT Capsule Type 55-B Exterior",
    ...
    ["Interiors.DefaultTTCapsuleType55B"] = "TT Capsule Type 55-B Default",
    ...
    ["Settings.Sections.Global.HealthToShieldsRatio.Description"] = "The proportion of health and shields values",
