...
T.Phrases = {
    ...
    ["Controls.EngineRelease.ArtronAdded"] = "Health has been wasted to charge artron energy in the vortex",
    ...
    ["Settings.Sections.Misc.Flight.FlightToFloatIfNoArtron"] = "Enable anti-gravs if artron depleted",
    ["Settings.Sections.Misc.Flight.FlightToFloatIfNoArtron.Description"] = "Should anti-gravs be enabled automatically when artron energy is depleted in flight?",
