...
T.Phrases = {
    ...
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyChargeFrequency"] = "Charge frequency (no handbrake)",
    ...
    ["Settings.Sections.Global.ArtronEnergy.ArtronEnergyMax"] = "Max energy",
