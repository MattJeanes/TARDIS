...
T.Phrases = {
    ...
    ["Settings.Sections.Misc.SpawnmenuInteriorIcons"] = "Show interiors in spawnmenu",
    ["Settings.Sections.Misc.SpawnmenuInteriorIcons.Description"] = "Should the spawnmenu have alternative icons with interiors?",
