...
T.Phrases = {
    ...
    ["E2.Error"] = "Can't call TARDIS functions on something other than a TARDIS.",
    ...
    ["Security.E2.UseDenied"] = "Can't call TARDIS set functions on another's TARDIS with Isomorphic Security active!",
