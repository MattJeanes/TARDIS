...
T.Phrases = {
    ...
    ["Settings.Sections.Performance.SmoothLightTransitions"] = "Smooth Lighting Transitions",
    ["Settings.Sections.Performance.SmoothLightTransitions.Description"] = "Should interior lights fade in/out? (requires Lighting Override)",
