...
T.Phrases = {
    ...
    ["Parts.DefaultDirectionalPointer.Text"] = "Suuntaosoitin",
    ...
    ["Settings.Sections.Misc.Language.Description"] = "Lisäosan kieli, käyttää puuttuvien käännösten kohdalla englantia",
    ...
    ["ThirdPerson.KeyHint"] = "VIHJE: Käytä '%s + %s' näppäimiä siirtyäksesi kolmannen persoonan tilaan",
