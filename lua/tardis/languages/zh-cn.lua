...
T.Phrases = {
    ...
    ["Binds.Sections.ThirdPerson.ToggleFloat.Description"] = "使塔迪斯如同无重力一般飞行",
    ["Binds.Sections.ThirdPerson.TogglePhyslock"] = "切换物理锁定",
    ["Binds.Sections.ThirdPerson.TogglePhyslock.Description"] = "使塔迪斯在空间中不可移动",
    ["Chameleon.ExteriorSelected"] = "已选择新外观",
    ["Chameleon.FailedExteriorSelect"] = "无法选择新外观",
    ["Chameleon.FailReasons.AlreadyChanging"] = "外观已经在改变！",
    ["Chameleon.FailReasons.AlreadySelected"] = "此外观已被选中",
    ["Chameleon.FailReasons.DoorsOpen"] = "等待关门...",
    ["Chameleon.FailReasons.NoPower"] = "变色龙电路在没有电源的情况下不工作",
    ["Chameleon.FailReasons.NotEnoughArtron"] = "没有足够的 artron 能量来切换变色龙电路",
    ["Chameleon.FailReasons.SameSelected"] = "TARDIS 已经有了这个外观",
    ...
    ["Exteriors.TTCapsuleType55B"] = "TT 胶囊类型 55-B",
    ...
    ["Interiors.Default.Versions.TTCapsuleType55B"] = "50-B型 TT太空舱 外部",
    ...
    ["Interiors.DefaultTTCapsuleType55B"] = "50-B型 TT太空舱 默认",
