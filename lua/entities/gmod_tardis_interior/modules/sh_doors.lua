...
if SERVER then
	ENT:AddHook("Initialize", "doors", function(self)
		util.PrecacheModel("models/drmatt/tardis/exterior/door.mdl") -- Need to precache or model might be invisible clientside
	end)
else
	ENT:AddHook("Initialize", "doors", function(self)
		local e=ents.CreateClientProp("models/drmatt/tardis/exterior/door.mdl")
